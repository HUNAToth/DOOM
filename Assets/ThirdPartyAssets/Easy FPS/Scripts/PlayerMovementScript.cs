...
public class PlayerMovementScript : MonoBehaviour
{
	...
	*/
    void PlayerMovementLogic()
    {
        ...
        rb.velocity =
            new Vector3(horizontalMovement.x,
                rb.velocity.y,
        ...
        {
            rb
                .AddRelativeForce(Input.GetAxis("Horizontal") *
                accelerationSpeed *
                Time.deltaTime,
                0,
	...
	*/
    ...
    public float accelerationSpeed = 100000.0f;
	...
	*/
    ...
    [
        Tooltip(
            "Put BulletSpawn gameobject here, palce from where bullets are created.")
    ]
    [HideInInspector]
	...
	*/
    ...
    private void RaycastForMeleeAttacks()
    {
        ...
        //middle row
        ray1 =
            new Ray(bulletSpawn.position + (bulletSpawn.right * offsetStart),
                bulletSpawn.forward +
        ...
        ray5 =
            new Ray(bulletSpawn.position -
                ...
                (bulletSpawn.up * rayDetectorMeeleSpace));
        ray6 =
            new Ray(bulletSpawn.position + (bulletSpawn.up * offsetStart),
