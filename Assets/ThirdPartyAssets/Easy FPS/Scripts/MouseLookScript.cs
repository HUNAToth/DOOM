...
public class MouseLookScript : MonoBehaviour
{
	...
	*/
    void HeadMovement()
    {
        ...
        zRotation =
            Mathf.Lerp(zRotation, wantedZ, Time.deltaTime * timerToRotateZ);
    }
    ...
    [HideInInspector]
    public float mouseSensitvity_notAiming = 500;
...
*/
    ...
    [
        Tooltip(
            "Speed that determines how much camera rotation will lag behind mouse movement.")
    ]
    public float
 ...
 */
    void MouseInputMovement()
    {
        ...
        wantedCameraXRotation =
            Mathf.Clamp(wantedCameraXRotation, bottomAngleView, topAngleView);
    }
 ...
 */
    void ApplyingStuff()
    {
        currentYRotation =
            Mathf
                .SmoothDamp(currentYRotation,
                wantedYRotation,
                ref rotationYVelocity,
                yRotationSpeed);
        currentCameraXRotation =
            Mathf
                .SmoothDamp(currentCameraXRotation,
                wantedCameraXRotation,
                ref cameraXVelocity,
                xCameraSpeed);
        ...
        myCamera.localRotation =
            Quaternion.Euler(currentCameraXRotation, 0, zRotation);
    }
