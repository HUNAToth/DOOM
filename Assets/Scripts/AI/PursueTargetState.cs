...
public class PursueTargetState : State
{
    ...
    )
    {
        ...
        enemyManager.distanceFromTarget =
            Vector3
                .Distance(enemyManager.currentTarget.transform.position,
                transform.position);
        ...
        if (enemyManager.distanceFromTarget > enemyManager.maximumAttackRange)
        {
            enemyAnimatorManager
                .anim
                .SetFloat("Vertical", 1, 0.1f, Time.deltaTime);
        }
        ...
        transform.position =
            new Vector3(transform.position.x,
                enemyManager.navMeshAgent.transform.position.y,
    ...
    private void HandleRotateTowardsTarget(EnemyManager enemyManager)
    {
        ...
        {
            Vector3 direction =
                enemyManager.currentTarget.transform.position -
                transform.position;
            direction.y = 0;
            direction.Normalize();
        ...
        else
        {
            ...
            Vector3 relativeDirection =
                transform
                    .InverseTransformDirection(enemyManager
                        .navMeshAgent
                        .desiredVelocity);
            ...
            enemyManager
                .navMeshAgent
                .SetDestination(enemyManager.currentTarget.transform.position);
